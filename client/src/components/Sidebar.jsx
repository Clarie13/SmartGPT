...
const {chats, setSelectedChat, theme, setTheme,user, navigate, 
  createNewChat, setChats, fetchUserChats, setToken, token} = useAppContext();
       ...
       dark:border-white/15 rounded-md cursor-pointer hover:scale-103 transition-all'>
        <img src={assets.diamond_icon} className='w-4.5 dark:invert' alt='' />
                <div className='flex flex-col text-sm '>
                  ...
                  <p className='text-xs text-gray-400'>Purchase Credits to use further</p>
                </div>
       </div>
